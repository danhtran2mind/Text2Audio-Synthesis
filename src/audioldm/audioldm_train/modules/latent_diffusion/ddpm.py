        ...
        **kwargs,
        ...
        if optimize_ddpm_parameter:
            if unconditional_prob_cfg == 0.0:
                print("You choose to optimize DDPM. The classifier free guidance scale should be 0.1")
                unconditional_prob_cfg = 0.1
        else:
            if unconditional_prob_cfg == 0.1:
                print("You choose not to optimize DDPM. The classifier free guidance scale should be 0.0")
        ...
        super().__init__(
            ...
            cond_stage_config=cond_stage_config,  # Pass cond_stage_config to DDPM
            *args,
            **kwargs
        )
